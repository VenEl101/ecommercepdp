...
from .models import Product, ProductCategory, ProductItem, Cart, CartItem, OrderItem, Order, ShippingAddress, PromoCode, \
    Favorite, PaymentCard, Payment
...
class ProductVariantSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ProductItem
        fields = (
        'id', 'product', 'sku', 'current_price', 'original_price', 'color', 'size', 'stock_quantity', 'is_available')
...
class PaymentSerializer(serializers.ModelSerializer):
    class Meta:
        model = Payment
        fields = ['order', 'type', 'method', 'status', 'last_four', 'exp_date']
